/**
 * Form for adding or editing a recurring monthly or yearly contribution to an education
 * savings account (e.g. "$200/month" or "$5,000/year"), rendered inline on
 * EducationAccountDetailPage. Near-identical copy of retirement's
 * RecurringContributionForm - same start/end-date checkbox pattern, since a scheduled
 * contribution works identically regardless of account type. Passing a `contribution`
 * prop switches the form into edit mode: fields are pre-filled, `frequency`/start date
 * become read-only (the backend's RecurringContributionUpdate schema doesn't allow
 * changing them after creation), and the submit button reads "Save Changes".
 */
...
import type { EducationRecurringContribution } from '@/types'
